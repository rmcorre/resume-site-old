...
<div class="container-fluid h-100">
    <div class="row">
        <div class="col">
            <h2>INDUSTRY KNOWLEDGE ADMIN</h2>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <table class="table table-sm table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <c:forEach var="industryKnowledge" items="${industryKnowledgeList}">
        ...
        <%--                </c:url>--%>
                        ...
                        <tr>
                            <td>${industryKnowledge.area}</td>
                            <td>${industryKnowledge.active}</td>
        <%--                    <td>--%>
    ...
    <div class="row pb-1">
        <div class="col">
            ...
            <a class="btn btn-primary"
               href="${pageContext.request.contextPath}/industryKnowledge/industryKnowledgeCreate"
               type="button">Create
            </a>
        </div>
    </div>
